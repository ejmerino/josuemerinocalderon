...
CREATE TABLE persona (
    ...
    tipo VARCHAR(10) CHECK (tipo IN ('profesor', 'alumno')) NOT NULL
);
...
CREATE TABLE asignatura (
    ...
    tipo VARCHAR(100) CHECK (tipo IN ('básica', 'obligatoria', 'optativa')) NOT NULL,
...
CREATE TABLE alumno_se_matricula_asignatura (
    ...
    id_curso_escolar SERIAL NOT NULL,
